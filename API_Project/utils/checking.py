...
class Checking():
    ...
    """Метод для проверки наличия оязательных  полей в ответе запроса"""
    ...
    """Метод для проверки значений оязательных  полей в ответе запроса"""
    ...
    """Метод для проверки значений оязательных  полей в ответе запроса по заданному слову"""
    @staticmethod
